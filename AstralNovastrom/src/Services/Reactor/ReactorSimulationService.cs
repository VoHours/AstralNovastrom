...
namespace AstralNovastrom.src.Services.Reactor
{
    public class ReactorSimulationService
    {
        ...
        {
            // 模拟PSI稳定性变�?            _reactorStatus.PsiStability += (_random.NextDouble() - 0.5) * 0.1;
            ...
            // 更新稳定性状�?            _reactorStatus.IsStable = _reactorStatus.PsiStability > 5 && _reactorStatus.ExtractionEfficiency > 70;
